...
<p><?php printf(__('This clears the cache for all packages, used in the %s and %s shortcodes.', \Recras\Plugin::TEXT_DOMAIN), '<code>[recras-package]</code>', '<code>[recras-availability]</code>'); ?></p>
